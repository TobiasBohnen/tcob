...
void gl_texture::resize(size_i texsize, u32 depth, texture::format format)
{
    ...
    logger::Debug("gles_texture: created ID {}: width {}, height {}, depth {}", ID, texsize.Width, texsize.Height, depth);
}
