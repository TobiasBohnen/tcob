...
cfg_asset_loader_manager::cfg_asset_loader_manager(group& group)
    : _group {group}
{
    _group.add_bucket<gfx::shader>();
    add_loader(std::make_unique<cfg_shader_loader>(_group, _object));

    _group.add_bucket<gfx::texture>();
    add_loader(std::make_unique<cfg_texture_loader>(_group, _object));

    _group.add_bucket<gfx::material>();
    add_loader(std::make_unique<cfg_material_loader>(_group, _object));

    _group.add_bucket<gfx::cursor>();
    add_loader(std::make_unique<cfg_cursor_loader>(_group, _object));

    _group.add_bucket<gfx::font>();
    add_loader(std::make_unique<cfg_font_loader>(_group, _object));

    _group.add_bucket<gfx::font_family>();
    add_loader(std::make_unique<cfg_font_family_loader>(_group, _object));

    _group.add_bucket<gfx::frame_animation>();
    add_loader(std::make_unique<cfg_frame_animation_loader>(_group, _object));

    _group.add_bucket<audio::music>();
    add_loader(std::make_unique<cfg_music_loader>(_group, _object));

    _group.add_bucket<audio::sound>();
    add_loader(std::make_unique<cfg_sound_loader>(_group, _object));

#if defined(TCOB_ENABLE_ADDON_AUDIO_TINYSOUNDFONT)
    _group.add_bucket<audio::sound_font>();
    add_loader(std::make_unique<cfg_sound_font_loader>(_group, _object));
#endif
}
...
cfg_frame_animation_loader::cfg_frame_animation_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_music_loader::cfg_music_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_sound_loader::cfg_sound_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_sound_font_loader::cfg_sound_font_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_cursor_loader::cfg_cursor_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_font_loader::cfg_font_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_font_family_loader::cfg_font_family_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_material_loader::cfg_material_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_shader_loader::cfg_shader_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
cfg_texture_loader::cfg_texture_loader(group& group, object& object)
    : loader {group}
    , _object {object}
{
}
...
void cfg_texture_loader::prepare()
{
    ...
    locate_service<command_queue>().add([&]() { return check_async_load(); });
}
