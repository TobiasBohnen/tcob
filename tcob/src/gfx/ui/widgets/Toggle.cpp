...
void toggle::style::Transition(style& target, style const& from, style const& to, f64 step)
{
...
void toggle::on_draw(widget_painter& painter)
{
    ...
    rect.Position.X += static_cast<f32>(tickWidth * _style.ease_value(_tween.current_value()));
