...
public:
    ...
    auto get_texture(i32 layer = 0) -> asset_ptr<texture>;

    void begin_frame(size_i windowSize, f32 devicePixelRatio, i32 layer = 0, bool clear = true);
    void end_frame();
    void cancel_frame();
    ...
    void stroke_text(rect_f const& rect, utf8_string_view text);
...
private:
    ...
    void decompose_text(utf8_string_view text, rect_f const& rect);
