...
#define TCOB_ENABLE_TTF_FREETYPE
#define TCOB_ENABLE_TTF_STBTT
#define TCOB_ENABLE_TTF_LIBSCHRIFT

#define TCOB_ENABLE_ADDON_AUDIO_TINYSOUNDFONT
#define TCOB_ENABLE_ADDON_PHYSICS_BOX2D
#define TCOB_ENABLE_ADDON_PHYSICS_CHIPMUNK2D
#define TCOB_ENABLE_ADDON_SCRIPTING_LUA
#define TCOB_ENABLE_ADDON_SCRIPTING_SQUIRREL
#define TCOB_ENABLE_ADDON_DATA_SQLITE
#define TCOB_ENABLE_ADDON_GFX_LITEHTML

#define TCOB_ENABLE_FILETYPES_AUDIO_DRLIBS
#define TCOB_ENABLE_FILETYPES_AUDIO_VORBIS
#define TCOB_ENABLE_FILETYPES_AUDIO_LIBXMP
#define TCOB_ENABLE_FILETYPES_AUDIO_OPUS
#define TCOB_ENABLE_FILETYPES_GFX_QOI
#define TCOB_ENABLE_FILETYPES_GFX_WEBP
#define TCOB_ENABLE_FILETYPES_GFX_THEORA

/* #undef TCOB_BUILD_SHARED */
