...
void TextEx::on_start()
{
    ...
    _text0.material(resMgr.get<Material>("res", "mat-text0"));
    _text0.text("normal text");
    _text0.bounds({ { 0.05f, 0.01f }, { 0.5f, 0.5f } });

    _text1.material(resMgr.get<Material>("res", "mat-text1"));
    ...
    _text2.material(resMgr.get<Material>("res", "mat-text2"));
    ...
    _text3.material(resMgr.get<Material>("res", "mat-text3"));
